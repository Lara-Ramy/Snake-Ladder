...
void CardEleven::ReadCardParameters(Grid* pGrid) {
	if (number == 0) {
		...
		pOut->PrintMessage("CardEleven: Please enter cardPrice...");
		cardPrice = pIn->GetInteger(pOut);

		pOut->PrintMessage("CardEleven: Please enter fees...");
...
void CardEleven::Apply(Grid* pGrid, Player* pPlayer) {
	...
	Card* Card11Apply;
	Card11Apply->SetCardNumber(11);
	Card11Apply->Apply(pGrid, pPlayer);
